...
<body>
	<ul class="layui-nav layui-bg-green" lay-filter="">
		...
		<li class="layui-nav-item" style="float:right"><a href="/ncpsy/admin/home">管理员主页</a></li>
	</ul>
		...
		<div class="layui-row" style="margin-top:30px">
			...
			<div class="layui-col-md4">
				<form class="layui-form">
					<input type="text" value="ncp001-qy001" name="ncpid" required  lay-verify="required" placeholder="请输入农产品id,测试使用ncp001-qy001" autocomplete="off" class="layui-input" maxlength="20" id="ncpid">
				</form>
			</div>
	...
	<div class="footer layui-bg-gray" style="text-align:center;height:100px">
		<p style="line-height:100px">© 2019  </p>
	</div>
